...
class NNUNetV2Adapter:
    ...
    def predict_folder(
        ...
        device_id: int = 0,  #GPU ID in case of multiple GPUs
    ):
        # print("---- cuda_visible_device ", device_id, " -------")
        # print("input_dir= ", samples_dir)
        # print("output_dir= ", output_dir)
        # print("trainer_name= ", trainer_name)
        self.set_env()
        os.environ["CUDA_VISIBLE_DEVICES"] = str(device_id)  #-- added this line
        run_args = [
            "nnUNetv2_predict",
            "-i",
            samples_dir,
